function UserProfile() {
  return (
    <div className="user-profile">
      ...
      <img src="https://via.placeholder.com/150" alt="User" rounded-full sm:w-24 sm:h-24 md:w-36 md:h-36 mx-auto hover:scale-110 transition-transform duration-300 ease-in-out/>
      <h1 text-xl sm:text-lg md:text-xl text-blue-800 my-4 hover:text-blue-500>John Doe</h1>
