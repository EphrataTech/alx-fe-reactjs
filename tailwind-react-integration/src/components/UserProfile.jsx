function UserProfile() {
  return (
    <div className="user-profile">
      ...
      <img src="https://via.placeholder.com/150" alt="User" rounded-full w-36 h-36 sm:w-24 h-24 md:w-36 h-36mx-auto  hover:scale-110 transition-transform duration-300 ease-in-out/>
