function UserProfile() {
  return (
    <div className="user-profile">
      ...
      <img src="https://via.placeholder.com/150" alt="User" rounded-full w-24 h-24 md:w-36 md:h-36 mx-auto hover:scale-110 transition-transform duration-300 ease-in-out/>
